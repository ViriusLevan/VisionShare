...
public class Model_PlacesCom implements Serializable {
    ...
    public Model_PlacesCom(){
    }

    public Model_PlacesCom(String idplace, String idplacecom, String conplacecom, String timeplacecom, String uidplacecom) {
