...
public class FundingCom implements Serializable {
    ...
    public FundingCom(String idfunding, String idfundingcom, String confundingcom, String timefundingcom, String uidfundingcom) {
