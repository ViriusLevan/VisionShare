...
public class NewsComRep implements Serializable {
    ...
    public NewsComRep(String idnewscom, String idnewscomrep, String connewscomrep, String timenewscomrep, String uidnewscomrep) {
